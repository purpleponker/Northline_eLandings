...
- drag and drop the desired profiles into the file explower browser for the PTI program, be sure NOT to drop themthe files into one of the internal folders
